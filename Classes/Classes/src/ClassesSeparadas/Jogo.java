...
import ClassesSeparadas.Pacman;
...
public class Jogo extends JFrame implements ActionListener {
	...
	int px=13, py=23, prx=13, pry=15,pbx=15,pby=15;
    int FanR = 0;
    int FanB =0;
    int PacM = 0;
    int vida = 3;
    ...
    public void jogo() {
       System.out.print(pacman.getBounds());
       System.out.print(Fan.getBounds());
       if (iniciar) {
	...
	/*public void sair(int pry,char mapa[][]) {
		if(mapa[12][13]=='z'&& mapa[12][14]=='z'){
				pry=-1;
